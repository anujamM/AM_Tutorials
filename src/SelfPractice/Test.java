...
interface a {
	void show(int i);
	void get(int j, String k);
}

public class Test {

	// public static class xyz implements a{
	//
	// @Override
	// public void show() {
	...
	public static void main(String[] args) {
		...
		a obj = new a() {
			...
			@Override
			public void get(int j, String k) {
				// TODO Auto-generated method stub
...
//		};
	...
	// String str = "Anujam";
	//
	// String[] first = {str.substring(0, (str.length()/2-1)),
	...
	//
	// String[] twoHalves = {str.substring(0, (str.length()/2-1)),
	// str.substring((str.length()/2), (str.length()-1))};
	//
	...
	//
	// return vowelCounter(twoHalves[0], vowels) == vowelCounter(twoHalves[1],
	// vowels);
	//
	//
	// }
